...
parser.add_argument('--bert_vocab_file', default='/ssd/home/pretrained_model/chinese_roberta_wwm_base_ext_pytorch/vocab.txt')
parser.add_argument('--root_path', default='./data/')
parser.add_argument('--bert', default='/ssd/home/pretrained_model/chinese_roberta_wwm_base_ext_pytorch')
...
parser.add_argument('--save_param_dir', default= '/ssd/home/param_model/')
